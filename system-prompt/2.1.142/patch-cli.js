...
// Configuration
const EXPECTED_VERSION = '2.1.142';
const EXPECTED_HASHES = {
  npm: 'TODO',
  'native-linux-arm64': 'TODO',
  'native-linux-x64': 'TODO',
  'native-macos-arm64': '87e93cfb2fb091d619182f3894e138c9a2ab85f86b75d15943c86ef8337db739',
...
const patches = [
  ...
  { name: 'Gut Zm3 (# Doing tasks section, ~3953 bytes)',
    customRegex: /function ([a-zA-Z0-9_$]+)\(\)\{let _=\[\.\.\.\["Don't add features[\s\S]*?return\["# Doing tasks",\.\.\.hp\([A-Za-z_]\)\]\.join\(`\n`\)\}/,
    customReplace: 'function $1(){return null}' },
  { name: 'Gut Vm3 (# Session-specific guidance, ~3674 bytes)',
    customRegex: /function ([a-zA-Z0-9_$]+)\(H,_,q\)\{let K=EB\(\)[\s\S]*?return\["# Session-specific guidance",\.\.\.hp\([A-Za-z_]\)\]\.join\(`\n`\)\}/,
    customReplace: 'function $1(H,_,q){return null}' },
  { name: 'Gut wm3 (# Text output / anti-verbosity, ~1744 bytes)',
    customRegex: /function ([a-zA-Z0-9_$]+)\(H\)\{if\(f\$\(H\)\)\{[\s\S]*?intermediate files\.`\}/,
